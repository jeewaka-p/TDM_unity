...
public class GridEnvironment : Environment
{
    ...
    public override void MiddleStep(int action)
    {
        ...
        //This should define the movements of the Agent in the X, Z Y Plane
        ...
        if (action == 3)
        {
            ...
            {
                visualAgent.transform.position = ; //Complete
            }
        }
